    ...
    def loadData(self):
        try:
            ...
            if self.useLexicon != 0:
                self.dl = DicLexicon('preprocessing/postagger/hmmtagger/resource/inlex.txt',
                                     'preprocessing/postagger/hmmtagger/resource/cattable.txt',
                                     self.model.getNumberTags())
        except:
